...
(1, 'admin', '123', 'Yafi Adyatma', 1, 'aktif'),
(6, 'hendro', '123', 'Hendro', 2, 'aktif'),
(7, 'fitri', '123', 'Fitri', 2, 'aktif'),
(8, 'yafi', '123', 'Yafi', 2, 'aktif'),
(21, 'fiaz', '123', 'Faiz', 2, 'aktif'),
(22, 'lia', '123', 'Amalia', 3, 'aktif');
...
--
ALTER TABLE `tb_masakan`
  MODIFY `id_masakan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
